 ...
 *
 * Sobe o servidor de partidas local e abre duas janelas do app de uma vez —
 * o suficiente para um 1×1 e para ver o outro boneco se mexendo.
 *
 *   npm run dev            -> 2 janelas
 *   npm run dev -- 4       -> 4 janelas
 */
...
const janelas = Number(process.argv[2]) || 2;
const filhos = [];
