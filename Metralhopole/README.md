...
- Durante a partida, a mesa ocupa a tela inteira e as ações aparecem em painéis flutuantes. `Esc` abre e fecha o painel com código da sala, jogadores, propriedades, histórico, pausa, reconexão, regras e saída.
